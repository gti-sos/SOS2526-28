import { h as head } from './server-Bl9qdiYN.js';
...
function _layout($$renderer, $$props) {
	...
	$$renderer.push(`<div class="app-layout svelte-12qhfyh"><header class="site-header svelte-12qhfyh"><div class="header-content svelte-12qhfyh"><h2 class="svelte-12qhfyh">👥 SOS GRUPO 28</h2> <nav class="svelte-12qhfyh"><a href="/" class="nav-btn svelte-12qhfyh">🏠 INICIO</a> <a href="https://github.com/gti-sos/SOS2526-28" target="_blank" class="nav-btn svelte-12qhfyh">📁 REPOSITORIO</a> <a href="/about" class="nav-btn svelte-12qhfyh">ℹ️ ABOUT</a></nav></div></header> <main class="main-content svelte-12qhfyh">`);
	children($$renderer);
	$$renderer.push(`<!----></main> <footer class="site-footer svelte-12qhfyh"><p>© 2026 - Sistemas Orientados a Servicios - ETSII</p></footer></div>`);
}

export { _layout as default };
//# sourceMappingURL=_layout.svelte-Dto5SwEm.js.map
