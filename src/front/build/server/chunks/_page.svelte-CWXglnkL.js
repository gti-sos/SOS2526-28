import { h as head, a3 as ensure_array_like, m as escape_html, a4 as attr } from './server-Bl9qdiYN.js';
...
function _page($$renderer) {
	...
	head("cwls5q", $$renderer, ($$renderer) => {
		$$renderer.title(($$renderer) => {
			$$renderer.push(`<title>About - SOS2526-28</title>`);
		});
	});
...
//# sourceMappingURL=_page.svelte-CWXglnkL.js.map
