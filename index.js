...
app.get("/samples/JDD", (req, res) => {
    ...
    res.send(`La media de 'degree' para '${paisBuscado}' es: ${mediaDegrees}`);
    console.log("Acceso a /samples/JDD - Algoritmo replicado correctamente");
});
